...
async function main() {
  ...
  try {
    ...
    // 7. Check if the timestamp field is indeed a BigInt in the database
    ...
    if (randomSnapshot) {
      ...
      console.log(`- timestamp: ${typeof randomSnapshot.timestamp} (value: ${randomSnapshot.timestamp.toString()})`);
      console.log(`- blockNumber: ${typeof randomSnapshot.blockNumber} (value: ${randomSnapshot.blockNumber.toString()})`);
      console.log(`- price0: ${typeof randomSnapshot.price0} (value: ${randomSnapshot.price0})`);
      console.log(`- price1: ${typeof randomSnapshot.price1} (value: ${randomSnapshot.price1})`);
    }
